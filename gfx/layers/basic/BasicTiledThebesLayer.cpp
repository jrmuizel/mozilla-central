                                   ...
                                   void* aCallbackData)
{
...
#endif
    mCallback(mThebesLayer, ctxt, aInvalidateRegion, aInvalidateRegion, mCallbackData);
  }
  ...
  if (PR_IntervalNow() - start > 30) {
    ...
    if (aInvalidateRegion.IsComplex()) {
      printf_stderr("Complex region\n");
      nsIntRegionRectIterator it(aInvalidateRegion);
